            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold">Share Phone Number</h2>
                    <p className="text-sm text-gray-500">With {recipientName}</p>
                  </div>
                </div>
                <button
                  onClick={onClose}
              ...
              <div className="space-y-4">
                {/* Phone Display */}
                <div className="bg-linear-to-br from-primary-50 to-blue-50 border-2 border-primary-200 rounded-lg p-4">
                  <p className="text-sm text-gray-600 mb-1">Your Phone Number</p>
                  <p className="text-2xl font-bold text-primary-600">{userPhone}</p>
                </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-yellow-800 mb-1">Privacy Notice</p>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <p className="text-sm text-blue-800">
                    💡 This will send your phone number in the chat. You can call or text each other directly.
                  </p>
                </div>
              </div>
